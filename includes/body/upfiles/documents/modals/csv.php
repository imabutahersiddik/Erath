    ...
    <input type="file" id="fileInputCSV" accept=".csv" style="margin: 20px 0;">
    ...
    <script>
        document.getElementById('encryptCSVBtn').addEventListener('click', function() {
            ...
            reader.onload = function(event) {
                ...
                CSVoutputUrl.style.display = 'block';
                ...
                visitLink.innerText = 'Download CSV';
            };
