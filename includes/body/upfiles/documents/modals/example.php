    ...
    <button id="copyBtnexample" style="display:none; background-color: #007BFF; border: none; color: white; padding: 15px 30px; text-align: center; text-decoration: none; display: inline-block; font-size: 18px; margin: 10px 0; cursor: pointer; border-radius: 5px; transition: background-color 0.3s;">Copy URL</button>
    <br>
    ...
    <script>
        document.getElementById('encryptPdfBtn').addEventListener('click', function() {
            ...
            reader.onload = function(event) {
                ...
                const copyBtnexample = document.getElementById('copyBtnexample');
                copyBtnexample.style.display = 'block';
                copyBtnexample.addEventListener('click', () => {
