...
<input type="file" id="fileInput" accept=".arj">
...
<br>
<a id="downloadLink" style="display:none;">Download ARJ</a>
...
document.getElementById('encryptBtn').addEventListener('click', function() {
    ...
    reader.onload = function(event) {
        ...
        const url = "https://erath.vercel.app/archives/arj/" + base64Data;
        ...
        downloadLink.innerText = ' Download ARJ';
