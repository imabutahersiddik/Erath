...
<input type="file" id="fileInput" accept=".ace">
...
<br>
<a id="downloadLink" style="display:none;">Download ACE</a>
...
document.getElementById('encryptBtn').addEventListener('click', function() {
    ...
    reader.onload = function(event) {
        ...
        const url = "https://erath.vercel.app/archives/ace/" + base64Data;
        ...
        downloadLink.innerText = ' Download ACE';
