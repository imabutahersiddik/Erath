...
<input type="file" id="fileInput" accept=".zst">
...
<br>
<a id="downloadLink" style="display:none;">Download ZST</a>
...
document.getElementById('encryptBtn').addEventListener('click', function() {
    ...
    reader.onload = function(event) {
        ...
        const url = "https://erath.vercel.app/archives/zst/" + base64Data;
        ...
        downloadLink.innerText = ' Download ZST';
