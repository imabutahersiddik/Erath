...
<input type="file" id="fileInput" accept=".vhd">
...
<br>
<a id="downloadLink" style="display:none;">Download VHD</a>
...
document.getElementById('encryptBtn').addEventListener('click', function() {
    ...
    reader.onload = function(event) {
        ...
        const url = "https://erath.vercel.app/archives/vhd/" + base64Data;
        ...
        downloadLink.innerText = ' Download VHD';
