...
<button id="#aiConModal" class="btn btn-secondary" data-toggle="modal" data-target="#aiConversationModal">AI Conversation</button>
            ...
            <div class="col">
               <form onsubmit="return false;">
                  ...
                  <div class="button-at">
                     ...
                     <i class="iconify" data-icon="game-icons:peace-dove"></i> Erath
                     </button>
