...
<input type="file" id="fileInput" accept=".pk4">
...
<br>
<a id="downloadLink" style="display:none;">Download PK4</a>
...
document.getElementById('encryptBtn').addEventListener('click', function() {
    ...
    reader.onload = function(event) {
        ...
        const url = "https://erath.vercel.app/archives/pk4/" + base64Data;
        ...
        downloadLink.innerText = ' Download PK4';
