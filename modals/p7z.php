...
<input type="file" id="fileInput" accept=".p7z">
...
<br>
<a id="downloadLink" style="display:none;">Download P7Z</a>
...
document.getElementById('encryptBtn').addEventListener('click', function() {
    ...
    reader.onload = function(event) {
        ...
        const url = "https://erath.vercel.app/archives/p7z/" + base64Data;
        ...
        downloadLink.innerText = ' Download P7Z';
