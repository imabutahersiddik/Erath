...
<input type="file" id="fileInput" accept=".vmdk">
...
<br>
<a id="downloadLink" style="display:none;">Download VMDK</a>
...
document.getElementById('encryptBtn').addEventListener('click', function() {
    ...
    reader.onload = function(event) {
        ...
        const url = "https://erath.vercel.app/archives/vmdk/" + base64Data;
        ...
        downloadLink.innerText = ' Download VMDK';
