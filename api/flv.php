...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/flv\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:video/x-flv;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download FLV File';
        });
    </script>
</body>
</html>