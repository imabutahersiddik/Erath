...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/jpg\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:image/jpg;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download JPEG File';
        });
    </script>
</body>
</html>