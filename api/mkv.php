...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/mkv\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:video/x-matroska;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download MKV File';
        });
    </script>
</body>
</html>