...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/heic\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:image/heic;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download HEIC File';
        });
    </script>
</body>
</html>