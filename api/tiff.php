...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/tiff\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:image/tiff;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download TIFF File';
        });
    </script>
</body>
</html>