...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/xlsx\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:application/xlsx;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download XLSX File';
        });
    </script>
</body>
</html>