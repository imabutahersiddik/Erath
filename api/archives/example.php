...
<body>
    ...
    <ol>
        <li>
            <strong>Download the pdf File:</strong>
            After clicking the download link, a file with a random number and the pdf extension will be saved to your device.
        </li>
        <li>
            <strong>Open the pdf File:</strong>
            Use an archiving tool (like WinRAR, 7-Zip, or any other compatible software) to open the downloaded pdf file.
        </li>
        <li>
            <strong>Locate the .bin File:</strong>
            Inside the pdf file, you will find a .bin file. This file contains your original content.
        </li>
        <li>
            <strong>Rename the .bin File:</strong>
            Right-click on the .bin file and choose to rename it. Change the file extension from .bin to .pdf. For example, if the file is named <code>random_number.bin</code>, rename it to <code>filename.pdf</code>.
        </li>
        <li>
            <strong>Extract the .pdf File:</strong>
            Now, use the archiving tool again to extract the newly renamed <code>filename.pdf</code> file. This will reveal the original file content.
        </li>
        <li>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            downloadLink.download = 'downloaded_file.pdf'; // Change this if you want a different filename
