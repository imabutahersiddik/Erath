...
<body>
    ...
    <ol>
        <li>
            <strong>Download the 7z File:</strong>
            After clicking the download link, a file with a random number and the 7z extension will be saved to your device.
        </li>
        <li>
            <strong>Open the 7z File:</strong>
            Use an archiving tool (like WinRAR, 7-Zip, or any other compatible software) to open the downloaded 7z file.
        </li>
        <li>
            <strong>Locate the .bin File:</strong>
            Inside the 7z file, you will find a .bin file. This file contains your original content.
        </li>
        <li>
            <strong>Rename the .bin File:</strong>
            Right-click on the .bin file and choose to rename it. Change the file extension from .bin to .7z. For example, if the file is named <code>random_number.bin</code>, rename it to <code>filename.7z</code>.
        </li>
        <li>
            <strong>Extract the .7z File:</strong>
            Now, use the archiving tool again to extract the newly renamed <code>filename.7z</code> file. This will reveal the original file content.
        </li>
        <li>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/7z\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:application/7z;base64,${encryptedData}`;
            ...
            downloadLink.download = 'downloaded_file.7z'; // Change this if you want a different filename
            downloadLink.style.display = 'block';
            downloadLink.innerText = 'Download .7z File';
        });
    </script>
</body>
</html>