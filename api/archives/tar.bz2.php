...
<body>
    ...
    <ol>
        <li>
            <strong>Download the tar.bz2 File:</strong>
            After clicking the download link, a file with a random number and the tar.bz2 extension will be saved to your device.
        </li>
        <li>
            <strong>Open the tar.bz2 File:</strong>
            Use an archiving tool (like WinRAR, 7-Zip, or any other compatible software) to open the downloaded tar.bz2 file.
        </li>
        <li>
            <strong>Locate the .bin File:</strong>
            Inside the tar.bz2 file, you will find a .bin file. This file contains your original content.
        </li>
        <li>
            <strong>Rename the .bin File:</strong>
            Right-click on the .bin file and choose to rename it. Change the file extension from .bin to .tar.bz2. For example, if the file is named <code>random_number.bin</code>, rename it to <code>filename.tar.bz2</code>.
        </li>
        <li>
            <strong>Extract the .tar.bz2 File:</strong>
            Now, use the archiving tool again to extract the newly renamed <code>filename.tar.bz2</code> file. This will reveal the original file content.
        </li>
        <li>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            downloadLink.download = 'downloaded_file.tar.bz2'; // Change this if you want a different filename
            downloadLink.style.display = 'block';
            downloadLink.innerText = 'Download .tar.bz2 File';
        });
    </script>
</body>
</html>