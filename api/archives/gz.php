...
<body>
    ...
    <ol>
        ...
        <li>
            ...
            Right-click on the .bin file and choose to rename it. Change the file extension from .bin to .gz. For example, if the file is named <code>random_number.bin</code>, rename it to <code>filename.gz</code>.
        </li>
        <li>
            <strong>Extract the .gz File:</strong>
            Now, use the archiving tool again to extract the newly renamed <code>filename.gz</code> file. This will reveal the original file content.
        </li>
        <li>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/gz\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:application/gz;base64,${encryptedData}`;
            ...
            downloadLink.download = 'downloaded_file.gz'; // Change this if you want a different filename
            downloadLink.style.display = 'block';
            downloadLink.innerText = 'Download .gz File';
        });
    </script>
</body>
</html>