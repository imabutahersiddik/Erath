...
<body>
    ...
    <ol>
        <li>
            <strong>Download the xz File:</strong>
            After clicking the download link, a file with a random number and the xz extension will be saved to your device.
        </li>
        <li>
            <strong>Open the xz File:</strong>
            Use an archiving tool (like WinRAR, 7-Zip, or any other compatible software) to open the downloaded xz file.
        </li>
        <li>
            <strong>Locate the .bin File:</strong>
            Inside the xz file, you will find a .bin file. This file contains your original content.
        </li>
        <li>
            <strong>Rename the .bin File:</strong>
            Right-click on the .bin file and choose to rename it. Change the file extension from .bin to .xz. For example, if the file is named <code>random_number.bin</code>, rename it to <code>filename.xz</code>.
        </li>
        <li>
            <strong>Extract the .xz File:</strong>
            Now, use the archiving tool again to extract the newly renamed <code>filename.xz</code> file. This will reveal the original file content.
        </li>
        <li>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/xz\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            downloadLink.download = 'downloaded_file.xz'; // Change this if you want a different filename
            downloadLink.style.display = 'block';
            downloadLink.innerText = 'Download .xz File';
        });
    </script>
</body>
</html>