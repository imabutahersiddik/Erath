...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/docx\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:application/docx;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download DOCX File';
        });
    </script>
</body>
</html>