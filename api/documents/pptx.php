...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/pptx\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:application/pptx;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download PPTX File';
        });
    </script>
</body>
</html>