...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/webp\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:image/webp;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download WEBP File';
        });
    </script>
</body>
</html>