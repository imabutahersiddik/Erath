...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/svg\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:image/svg+xml;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download SVG File';
        });
    </script>
</body>
</html>