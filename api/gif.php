...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/gif\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:image/gif;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download GIF File';
        });
    </script>
</body>
</html>