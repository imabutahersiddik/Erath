...
<body>
    ...
    <ol>
        <li>
            <strong>Download the z File:</strong>
            After clicking the download link, a file with a random number and the z extension will be saved to your device.
        </li>
        <li>
            <strong>Open the z File:</strong>
            Use an archiving tool (like WinRAR, 7-Zip, or any other compatible software) to open the downloaded z file.
        </li>
        <li>
            <strong>Locate the .bin File:</strong>
            Inside the z file, you will find a .bin file. This file contains your original content.
        </li>
        <li>
            <strong>Rename the .bin File:</strong>
            Right-click on the .bin file and choose to rename it. Change the file extension from .bin to .z. For example, if the file is named <code>random_number.bin</code>, rename it to <code>filename.z</code>.
        </li>
        <li>
            <strong>Extract the .z File:</strong>
            Now, use the archiving tool again to extract the newly renamed <code>filename.z</code> file. This will reveal the original file content.
        </li>
        <li>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/z\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:application/x-compress;base64,${encryptedData}`;
            ...
            downloadLink.download = 'downloaded_file.z'; // Change this if you want a different filename
            downloadLink.style.display = 'block';
            downloadLink.innerText = 'Download .z File';
        });
    </script>
</body>
</html>