...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/avi\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:video/avi;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download AVI File';
        });
    </script>
</body>
</html>