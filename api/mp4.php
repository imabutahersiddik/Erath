...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/mp4\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:video/x-msvideo;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download MP4 File';
        });
    </script>
</body>
</html>