...
<body>
    ...
    <ol>
        <li>
            <strong>Download the dmg File:</strong>
            After clicking the download link, a file with a random number and the dmg extension will be saved to your device.
        </li>
        <li>
            <strong>Open the dmg File:</strong>
            Use an archiving tool (like WinRAR, 7-Zip, or any other compatible software) to open the downloaded dmg file.
        </li>
        <li>
            <strong>Locate the .bin File:</strong>
            Inside the dmg file, you will find a .bin file. This file contains your original content.
        </li>
        <li>
            <strong>Rename the .bin File:</strong>
            Right-click on the .bin file and choose to rename it. Change the file extension from .bin to .dmg. For example, if the file is named <code>random_number.bin</code>, rename it to <code>filename.dmg</code>.
        </li>
        <li>
            <strong>Extract the .dmg File:</strong>
            Now, use the archiving tool again to extract the newly renamed <code>filename.dmg</code> file. This will reveal the original file content.
        </li>
        <li>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/dmg\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:application/x-apple-diskimage;base64,${encryptedData}`;
            ...
            downloadLink.download = 'downloaded_file.dmg'; // Change this if you want a different filename
            downloadLink.style.display = 'block';
            downloadLink.innerText = 'Download .dmg File';
        });
    </script>
</body>
</html>