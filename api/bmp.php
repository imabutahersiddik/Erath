...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/bmp\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:image/bmp;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download BMP File';
        });
    </script>
</body>
</html>