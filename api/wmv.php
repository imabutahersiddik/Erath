...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/wmv\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:video/x-ms-wmv;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download WMV File';
        });
    </script>
</body>
</html>