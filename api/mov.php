...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/mov\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:video/quicktime;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download MOV File';
        });
    </script>
</body>
</html>