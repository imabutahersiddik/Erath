...
<body>
    ...
    <script>
        ...
        document.getElementById('processUrlBtn').addEventListener('click', function() {
            ...
            const encryptedDataPattern = /\/\/[^\/]+\/png\/([^ ]+)/; // Adjusted regex to match any domain
            ...
            const base64Url = `data:image/png;base64,${encryptedData}`;
            ...
            downloadLink.innerText = 'Download PNG File';
        });
    </script>
</body>
</html>